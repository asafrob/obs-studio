...
struct obs_frontend_callbacks {
	...
	virtual void obs_frontend_start_streaming(void)=0;
	virtual void obs_frontend_stop_streaming(void)=0;
	virtual bool obs_frontend_streaming_active(void)=0;

	virtual void obs_frontend_start_recording(void)=0;
	virtual void obs_frontend_stop_recording(void)=0;
