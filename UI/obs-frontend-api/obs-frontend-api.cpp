...
void obs_frontend_start_streaming(void)
{
	if (callbacks_valid()) c->obs_frontend_start_streaming();
}

void obs_frontend_stop_streaming(void)
{
	if (callbacks_valid()) c->obs_frontend_stop_streaming();
}
...
void obs_frontend_start_recording(void)
{
	if (callbacks_valid()) c->obs_frontend_start_recording();
}

void obs_frontend_stop_recording(void)
{
	if (callbacks_valid()) c->obs_frontend_stop_recording();
}
