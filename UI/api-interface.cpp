...
struct OBSStudioAPI : obs_frontend_callbacks {
	...
	void obs_frontend_start_streaming(void) override
	{
		QMetaObject::invokeMethod(main, "StartStreaming");
	}

	void obs_frontend_stop_streaming(void) override
	{
	...
	void obs_frontend_start_recording(void) override
	{
		QMetaObject::invokeMethod(main, "StartRecording");
	}

	void obs_frontend_stop_recording(void) override
	{
